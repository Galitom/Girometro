  ...
  return (
    <div className="screen-in" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', gap: 20 }}>
      ...
      <div style={{ textAlign: 'center' }}>
        <h1 className="disp disp-tight glitch-title" style={{ fontSize: 'clamp(38px, 9vw, 52px)', fontWeight: 700, textTransform: 'uppercase', lineHeight: 0.9, margin: '0 0 14px' }}>Tornei</h1>
